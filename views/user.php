...
ultima_alteracao, criado_por, alterado_por, situacao -->
                ...
                <td>
                  ...
                  <div class="btn-group" role="group" aria-label="Ações">
                    <a class="btn btn-warning btn-sm" href="editar_user.php?id_vendas=<?php echo $fila['id_vendas'] ?>">
                      <i class="fa fa-edit"></i> Editar
                    </a>
                    <a class="btn btn-danger btn-sm btn-del" href="eliminar_user.php?id_vendas=<?php echo $fila['id_vendas'] ?>">
