...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        ...
        <a class="navbar-brand" href="user.php">
            ...
            <!-- style="width: 100px; max-width: 100%; height: auto; border-radius: 50%;"> -->
        </a>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a href="grafica.php" class="nav-link"><b>Grafico de Lojas</b> </a>
                </li>
                <li class="nav-item">
                    <a href="graficaVenda.php" class="nav-link"><b>Grafico de Vendas</b> </a>
                </li>
                <li class="nav-item">
                    <a href="graficaFuncionario.php" class="nav-link"><b>Grafico de Funcionario</b> </a>
                </li>
                <li class="nav-item">
                    <a href="graficaCliente.php" class="nav-link"><b>Grafico de Clientes</b> </a>
                </li>
                <li class="nav-item">
                    <a href="calculos.php" class="nav-link"><b>Calculo Taxa</b> </a>
                </li>
                <li class="nav-item">
                    <a href="cartao2.php" class="nav-link"><b>Calculo Cartão</b> </a>
                </li>
                <li class="nav-item">
                    <a href="planejamento.php" class="nav-link"><b>Planejamento</b> </a>
                </li>
